...
> This plugin is in early beta (`0.1.5-beta.2`). APIs, collection slugs, and block types may change between releases without a deprecation period. Do not use in production environments without thoroughly reviewing each update. Breaking changes will be noted in [CHANGELOG.md](./CHANGELOG.md).
